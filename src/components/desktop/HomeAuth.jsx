...
<div className='modal-double-input-container'>
  ...
  <span className='upload-button-text'>{advertPhoto===''?'Click to Upload Photo' : 'Click to Change Photo'} </span>
...
{adverts.map((advert, i)=>{
 return(
  ...
  <span className='name'><AccountCircleIcon className='post-icon-user'/>{advert.userName}</span>
